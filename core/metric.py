...
class MetricsTop():
    ...
    def __eval_mosi_classification(self, y_pred, y_true):
        ...
        wa=accuracy_score(y_pred_3, y_true)
        acc0=0
        num0=0
        num0_co=0
        acc1=0
        ...
        ua=((num0_co/num0)+(num1_co/num1)+(num2_co/num2))/3


            

        # wa=accuracy_score(y_pred_3, y_true,average='weighted')
    ...
    def __eval_iemocap_classification(self, y_pred, y_true):
        ...
        F1_score_4 = f1_score(y_pred_4, y_true, average='weighted')
...
def cal_acc5(y_pred, y_true):
    ...
    Mult_acc_5 = accuracy_score(y_pred_5, y_true)
    F1_score_5 = f1_score(y_pred_5, y_true, average='weighted')

    eval_results = {
        "Mult_acc_5": Mult_acc_5,
        "F1_score_5": F1_score_5
    }
